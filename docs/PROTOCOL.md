...
```json
{"version":1,"type":"COMMAND","commandId":"00000000-0000-4000-8000-000000000001","kind":"POWER_ON"}
{"version":1,"type":"QUERY","commandId":"00000000-0000-4000-8000-000000000001"}
{"version":1,"type":"FAULT","mode":"DROP_COMPLETION"}
```

Kinds: POWER_ON, CAPTURE, POWER_OFF. UUID required for command identity; reusing an ID with a different kind is invalid. Repeated identical commands return their durable status without repeating side effects.
...
| POST /api/runs | Start v1 procedure; body `{"requestId":"UUID"}`. Same ID returns same run. |
